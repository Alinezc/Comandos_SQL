...
--Subconsulta Independente
--Vendas dos dias, no ano de 2013,que no ano anterior foram os 5 dias com maior valor de vendas
SELECT OrderDate AS Data_da_Venda, SUM(TotalDue) AS Valor_TOtal_Diarios_de_Vendas
