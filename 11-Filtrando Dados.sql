...
SELECT Name,Color
FROM Production.Product
WHERE Name LIKE 'Chain%' -- like faz comparaçao com varios valores -- % no final puxa o resto que vem depois da palavra 
ORDER BY Name;
...
--Uso de DISTINCT EM Multiplas Colunas
