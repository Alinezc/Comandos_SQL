...
--Especificando o nome das colunas explicitamente e à ordem de inserção das colunas
...
--Se conversão implicita fosse possivel
...
--Se as colunas do mesmo tipo de dados:linha com dados "invalidos"
...
--Insert com colunas com Default
EXEC SP_HELP 'dbo.TAB1'
GO

--Erro se não explicar o valor
INSERT INTO dbo.TAB1(COL1,COL2,COL3)
VALUES (8,,'27/09/2019 00:00:00.000')
GO

--Ok
INSERT INTO dbo.TAB1(COL1,COL3)
...
INSERT INTO dbo.TAB1(COL1,COL3)
VALUES (9,'30/09/2019 00:00:00.000')
GO
SELECT * FROM dbo.TAB1
GO
...
--Erro: valor 0 para à chave estrangeira não foi encontrado na tabela pai
...
--INSERT com SEQUENCE
--NÃO fica atrelada a tabela \ campo
CREATE SEQUENCE dbo.SEQUENCE_TAB6 --drop para excluir tab
AS INT
START WITH 100
INCREMENT BY 1
GO
...
--Possivel Usar todos recursos da instruçao SELECT
INSERT INTO dbo.SUB_TAB6
SELECT TOP (1) *
FROM dbo.TAB6
ORDER BY COL6 ASC
...
--Erro: Colunas não nulas sem dados retornando pelo SELECT
...
--Possibilidade Usar as Diversas Opçoes para uma Instruçao SELECT
